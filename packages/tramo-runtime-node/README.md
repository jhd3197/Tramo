...
CLI wrapper around [`tramo-runtime`](../tramo-runtime). Run or validate a tramo workflow JSON file from a shell — on a server, in CI, or as a one-off on your laptop.
